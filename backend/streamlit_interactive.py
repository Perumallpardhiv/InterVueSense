...
from annotated_text import annotated_text, parameters# type: ignore
...
from scripts.parsers import ParseJobDesc, ParseResume# type: ignore
from scripts.ReadPdf import read_single_pdf# type: ignore
from scripts.similarity.get_score import *# type: ignore
from scripts.utils import get_filenames_from_dir# type: ignore
...
cwd = find_path("Resume-Matcher") # type: ignore
...
with st.spinner("Please wait..."):
    if (
        ...
        result = get_score(resume_string, jd_string) # type: ignore
